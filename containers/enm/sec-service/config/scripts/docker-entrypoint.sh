...
echo "sps=sps.${DOMAIN:-enm.local}" >> /ericsson/tor/data/global.properties
echo "netex=netex.${DOMAIN:-enm.local}" >> /ericsson/tor/data/global.properties
echo "COM_INF_LDAP_HOST=\"ldap-local.${DOMAIN:-enm.local}\"" >> /ericsson/tor/data/global.properties

echo "Content of global.properties is:"
cat /ericsson/tor/data/global.properties
...
sed -i 's/1389/1689/g' /ericsson/3pp/jboss/standalone/configuration/standalone-enm.xml
